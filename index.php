            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">いすゞ</a>
                        <a class="dropdown-item" href="#">ダイハツ</a>
                        <a class="dropdown-item" href="#">マツダ</a>
                        <a class="dropdown-item" href="#">アイシン精機</a>
                        <a class="dropdown-item" href="#">ホンダ熊本</a>
                        <a class="dropdown-item" href="#">コマツ</a>
                        <a class="dropdown-item" href="#">NTN</a>
                        <a class="dropdown-item" href="#">岐阜車体</a>
                        <a class="dropdown-item" href="#">コベルコ</a>
                        <a class="dropdown-item" href="#">トヨタ</a>
                        <a class="dropdown-item" href="#">日立建機</a>
                        <a class="dropdown-item" href="#">プライムアースEVエナジー</a>
                        <a class="dropdown-item" href="#">太陽誘電ケミカルテクノロジー</a>
                    </div>
                </li>
                <!-- /dropdown -->
                <li class="nav-item">
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img src="https://kikankou.co/wp-content/uploads/2018/06/ixp-top.png" class="img-fluid" alt="">
              </div>
              <div class="swiper-slide">
                <img src="https://kikankou.co/wp-content/uploads/2018/06/nyusya-iwai-top.png" class="img-fluid" alt="">
              </div>
              <div class="swiper-slide">
                <img src="https://kikankou.co/wp-content/uploads/2018/06/blog-top.png" class="img-fluid" alt="">
              </div>
              <div class="swiper-slide">
                <img src="https://kikankou.co/wp-content/uploads/2018/06/komatsu-top.png" class="img-fluid" alt="">
              </div>
            </div>
            <!-- Add Pagination -->
